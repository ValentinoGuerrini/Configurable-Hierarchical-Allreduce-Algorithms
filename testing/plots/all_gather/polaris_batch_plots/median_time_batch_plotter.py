...
# ---------------------------------------------------------
csv_files = [
    "./results_polaris_batch_comparison_2.csv",
    "./results_polaris_batch_comparison_4.csv",
    "./results_polaris_batch_comparison_8.csv",
    "./results_polaris_batch_comparison_16.csv",
    "./results_polaris_batch_comparison_32.csv",
    "./results_polaris_batch_comparison_64.csv"
]

titles = [
    "64 Processes (2 Nodes)",
    "128 Processes (4 Nodes)",
    "256 Processes (8 Nodes)",
    "512 Processes (16 Nodes)",
    "1024 Processes (32 Nodes)",
    "2048 Processes (64 Nodes)"
]
