...
5. [Debugging a Single Implementation](#debugging-a-single-implementation)  
6. [Makefile Targets & Parameters](#makefile-targets--parameters)  
7. [Examples](#examples)  
8. [License](#license)  
...
```
.
├── allreduce_k_reduce_scatter_algather.cpp
...
- Build & run full benchmark with 12 processes (4 per node, 3 nodes):
  ```bash
  make run-benchmark RANKS_PER_NODE=4 NUM_NODES=3
  ```
